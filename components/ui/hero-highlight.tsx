...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn("relative h-[40rem] flex items-center bg-background justify-center w-full group", containerClassName)}
...
export const Highlight = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <motion.span
      ...
      className={cn(`relative inline-block pb-1 px-1 rounded-lg bg-gradient-to-r from-emerald-200 to-green-300 dark:from-emerald-500 dark:to-green-600`, className)}
    >
      {children}
    </motion.span>
  );
